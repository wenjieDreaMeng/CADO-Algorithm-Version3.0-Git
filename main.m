...
%         CADOImprove_KMode_AC = CADOImprove_KMode_AC + CADOImprove_K_Mode_AC;
    ...
    fprintf(fid,'CADO SC_AVERAGE_AC = %8.4f,         CADO KMode_Average_AC = %8.4f\n',CADO_SC_AC/Times,CADO_KMode_AC/Times);
%     fprintf(fid,'CADOImprove SC_Average_AC = %8.4f,  CADOImprove KMode_Average_AC = %8.4f\n',CADOImprove_SC_AC/Times,CADOImprove_KMode_AC/Times);
end
fclose(fid);
